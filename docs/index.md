---
title: "Learn Data Science Free: Beginner to Master Course"
description: "Free data science course from beginner to advanced -- Python, pandas, statistics, EDA, visualization and experimentation lessons with real projects. Part of a 42-course free library."
---
...
| Level | Focus | Modules |
|-------|-------|---------|
| [Level 1 · Entry](level-1/index.md) | Python/pandas, cleaning, EDA, visualization, statistics fundamentals, correlation & regression | 9 topics + 1 project |
| [Level 2 · Intermediate](level-2/index.md) | Advanced pandas, hypothesis testing, plotly, feature engineering, A/B testing, SQL | 9 topics + 1 project |
| [Level 3 · Advanced](level-3/index.md) | Causal inference, forecasting, big data, dashboards, reproducible research, ethics | 9 topics + 1 project |
| [Level 4 · Master](level-4/index.md) | Leading teams, DS platforms, MLOps, experimentation at scale, strategy | 9 topics + 1 capstone |
...
- Every topic page has runnable code snippets — all you need is
  `pip install numpy pandas matplotlib seaborn scipy statsmodels`. Examples
  use small built-in or synthetic datasets, so there is nothing to download.
...
Free, structured, module-wise training across 41 other languages, platforms and disciplines:
...
<div class="mastery-grid">
  <a href="https://sigilipelli.github.io/ai-ml-mastery-path/">🤖 AI &amp; Machine Learning</a>
...
<p class="mastery-grid-category">Other</p>
<div class="mastery-grid">
  <a href="https://sigilipelli.github.io/workday-mastery-path/">🗓️ Workday</a>
  <a href="https://sigilipelli.github.io/cybersecurity-mastery-path/">🔒 Cybersecurity</a>
</div>
</div>
